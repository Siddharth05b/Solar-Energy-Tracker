...
import { Sun, Bolt, TrendingUp, CalendarIcon, Save, Pencil } from "lucide-react"
            ...
            {editingDay === entry.date ? (
              <div className="flex flex-col items-center" onClick={(e) => e.stopPropagation()}>
                <Input
                  ...
                  className="w-full text-center text-sm h-10 px-1 transition-colors duration-200"
    ...
    <Card className="w-full max-w-5xl overflow-hidden border-0 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.1)] dark:shadow-[0_20px_60px_-15px_rgba(0,0,0,0.5)] rounded-xl">
      <CardContent className="p-0">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 h-full">
          {/* Left Panel - Input */}
          <div className="bg-background p-4 sm:p-6 md:border-r border-border/40">
                      ...
                      >
                        {isEditingDate ? (
                          <Input
                            ...
                            className="absolute inset-0 border-0 focus-visible:ring-0 focus-visible:ring-offset-0"
                        ...
                        <FormItem>
                          ...
                          <div className="flex space-x-2">
                            ...
                            <Button
                              type="submit"
                              className={cn(
                                "bg-primary hover:bg-primary/90 text-primary-foreground transition-all h-12 sm:h-10 px-4 sm:px-3",
          ...
          <div className="col-span-2 bg-background p-4 sm:p-6">
